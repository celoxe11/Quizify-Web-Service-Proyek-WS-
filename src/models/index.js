...
Question.hasMany(QuestionImage, {
...
QuizSession.hasMany(SubmissionAnswer, {
  foreignKey: "quiz_session_id",
  constraints: false,
});
SubmissionAnswer.belongsTo(QuizSession, {
  foreignKey: "quiz_session_id",
  constraints: false,
});

// Question <-> SubmissionAnswer
Question.hasMany(SubmissionAnswer, {
  foreignKey: "question_id",
  constraints: false,
});
...
Question.hasOne(QuestionAccuracy, {
  foreignKey: "question_id",
  constraints: false,
});
QuestionAccuracy.belongsTo(Question, {
  foreignKey: "question_id",
  constraints: false,
});
...
// Avatar <-> Transaction (Untuk pembelian Avatar via item_id)
Avatar.hasMany(Transaction, { foreignKey: "item_id", constraints: false });
Transaction.belongsTo(Avatar, {
  foreignKey: "item_id",
  as: "avatar_detail",
  constraints: false,
});
